define ([], function (){
    return {
        moduleManager: {
            ...
            'CreditCardValidator': {base: 'Sds/Common/Validator/CreditCardValidator', directives: {cache: false}},
            'CurrencyValidator': {base: 'Sds/Common/Validator/CurrencyValidator', directives: {cache: false}},
            'CvvValidator': {base: 'Sds/Common/Validator/CvvValidator', directives: {cache: false}},

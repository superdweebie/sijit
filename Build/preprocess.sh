...
cat <<-__EOF__;
NAME
     build.sh - a convenience wrapper around the Sds build profile processor application

SYNOPSIS
     path/to/build.sh [--help] [--bin environment] [build system options]

DESCRIPTION
     build.sh is a shell script that wraps the Sds build profile processor located at /Sds/Build/main.js
